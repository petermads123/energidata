...
class EnergiDataService:
    """Class for collecting data from EnergiDataService."""

    def __init__(self) -> None:
        """Initialize the EnergiDataService class."""
...
if __name__ == "__main__":
    eds = EnergiDataService()
    start = pd.Timestamp("2026-04-01")
    end = pd.Timestamp("2026-04-04")
    bzs = ["DK1", "DK2"]

    da_prices = eds.get_dayahead_prices(start, end, bzs)
    imbalance_prices = eds.get_imbalance_prices(start, end, bzs)
